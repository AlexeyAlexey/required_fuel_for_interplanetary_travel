defmodule RequiredFuelForInterplanetaryTravel.MixProject do
  use Mix.Project

  def project do
    [
      app: :required_fuel_for_interplanetary_travel,
      version: "0.1.0",
      elixir: "~> 1.15",
  ...
  def application do
    [
      mod: {RequiredFuelForInterplanetaryTravel.Application, []},
